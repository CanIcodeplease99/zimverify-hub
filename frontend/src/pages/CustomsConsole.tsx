...
import { Truck, Database, CheckCircle2, TrendingUp, FileText, Plus } from "lucide-react";
...
const CustomsConsole = () => {
  ...
  const handleSubmit = () => {
    ...
    toast.success("Vehicle import registered", { 
      description: `Entry ${formData.entryNumber} added to national database` 
    });
        ...
        <motion.div variants={itemVariants}>
          <Card className="border-border/40 bg-card/70 backdrop-blur-sm">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button onClick={() => setAddDialogOpen(true)} className="font-body rounded-xl shadow-sm shadow-primary/10">
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="font-body">Enter complete vehicle import details for national database</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit} className="font-body rounded-xl">Register Vehicle</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
