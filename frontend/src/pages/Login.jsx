      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">ZVMS</h1>
            <p className="text-gray-600">Zimbabwe Vehicle Management System</p>
            <p className="text-sm text-gray-500 mt-2">ZIMRA - Customs & Border Control</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>For access, contact your system administrator</p>
          </div>

          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-800 font-medium mb-2">Quick Access (Demo):</p>
            <div className="text-xs text-blue-700 space-y-1">
              <p>• Admin: admin@zimra.gov.zw / Admin@123</p>
            </div>
          </div>
        </div>

        <div className="text-center mt-6 text-white text-sm">
          <p>© 2025 ZIMRA - All rights reserved</p>
        </div>
      </div>
    </div>
  );
