...
import { Shield, Eye, EyeOff, Lock, Users, ChevronRight, ArrowLeft, Home } from "lucide-react";
...
const AppLogin = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 relative">
      ...
      {/* Left: Login form */}
      <div className="flex items-center justify-center p-8 lg:p-16 bg-background pt-20">{/* Added pt-20 for back button space */}
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
